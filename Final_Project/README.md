...
<br>![Final Descriptive](images/1_Final_descriptive.png)
...
<br>![model 1 coefficients](images/2_model1_coefficient.png)
*   We have some metrics for model 1.  The R2_squared is 99%
<br>![model 1 metrics](images/3_model1_metrics.png)
*   Here is an example how model 1 predicts:
<br>![model 1 Sale Price examples](images/4_model1_saleprice_examples.png)
*   Here is the residuals plot of the model 1. The residual plot centers around the mean of zero.
<br>![model 1 residuals plot](images/5_model1_residuals_plot.png)
...
<br>![model 1 Sale Price prediction plot](images/6_model1_prediction_plot.png)
...
<br>![NN Model 3 summary](images/12_model3_summary.png)
*   Notice how the value of R2_squared is pretty good at 98.6%
<br>![model 3 metrics](images/12_model3_metrics.png)
*  Here is the sale price examples of model 3
<br>![model 3 sale price examples](images/13_model3_saleprice_examples.png)
*   As expected, model 3 is pretty good at predicting the Sale_Price as the two lines are overlapping
<br>![model 3 sale price prediction plot](images/15_model3_prediction_plot.png)
...
<br>![NN Model 4 summary](images/16_model4_summary.png)
*   One big difference is that it has no input of "List_Price"
*   Notice how the value of R2_squared is bad at 34.04%
<br>![model 3 metrics](images/16_model4_metrics.png)
*  Column "Prediction 4" lists the prediction of model 4.  Amazingly, it is far from the true Sale_Price.
<br>![model 4 sale price examples](images/17_model4_saleprice_examples.png)
*   As expected, model 4 is amazingly bad.
<br>![model 3 sale price prediction plot](images/18_model4_prediction_plot.png)

#### 5.  Conclusion
<br>![conclusion rq2_squared](images/20_conclusion_r2_squared.png)
...
<br>![Conclusion Prediction all](images/20_conclusion_prediction_all.png)

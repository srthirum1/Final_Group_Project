...
* Roles and Responsibilities:<br>
    ...
    o	DataBase: Dawit Alaro & Trong-Quyen Nguyen<br>
...
*   Joined two data sets together.  Cleaned up and deleted null values.<br> ![Data Processing Yeah Data is cleaned](Final_Project/images_ERD/data_processing_1.png)
*   Export the data to postgresql.  There are three sets of data exported: 'house_data.csv', 'sale_data.csv' and 'final_data.csv'.<br> ![Data Processing data export](Final_Project/images_ERD/data_processing_2.png)
...
*   The result is impressive, with R squared is 95%.  The model can explain 95% of the price variation.<br> ![Regression Basic MSE and R squared](Final_Project/images_ERD/Regression_Basic_1.png)
*   The coefficients for the colums "County_Index|SqFtTotal|Lot_Size|Age|BathsTotal|BedsTotal|BathsFull|BathsHalf|DOM|Year_Sold|List_Price" is below:<br> ![Regression Basic Model Coefficients](Final_Project/images_ERD/Regression_Basic_2.png)
...
<br>![Final Descriptive](Final_Project/images_ERD/1_Final_descriptive.png)
...
<br>![model 1 coefficients](Final_Project/images_ERD/2_model1_coefficient.png)
*   We have some metrics for model 1.  The R2_squared is 99%
<br>![model 1 metrics](Final_Project/images_ERD/3_model1_metrics.png)
*   Here is an example how model 1 predicts:
<br>![model 1 Sale Price examples](Final_Project/images_ERD/4_model1_saleprice_examples.png)
*   Here is the residuals plot of the model 1. The residual plot centers around the mean of zero.
<br>![model 1 residuals plot](Final_Project/images_ERD/5_model1_residuals_plot.png)
...
<br>![model 1 Sale Price prediction plot](Final_Project/images_ERD/6_model1_prediction_plot.png)
...
<br>![model 2 coefficients](Final_Project/images_ERD/7_model2_coefficient.png)
*   Notice how the r2_square drops significantly to 65.9%. Model 2 can only explain 65.9% of the sale_price accurately
<br>![model 2 metrics](Final_Project/images_ERD/8_model2_metrics.png)
*   Look at how apart model 2 predicts Sale_Price
<br>![model 2 Sale Price examples](Final_Project/images_ERD/9_model2_saleprice_examples.png)
*   Take a peak at the model 2 residuals plot. Its mean is centered around zero, but there are examples at the positive tail.
<br>![model 2 residual plot](Final_Project/images_ERD/10_model2_residuals_plot.png)
*   As expected, model 2 prediction is not as accurate as model 1, as seen by the blue line.
<br>![model 2 sale price prediction plot](Final_Project/images_ERD/11_model2_prediction_plot.png)
...
<br>![NN Model 3 summary](Final_Project/images_ERD/12_model3_summary.png)
*   Notice how the value of R2_squared is pretty good at 98.6%
<br>![model 3 metrics](Final_Project/images_ERD/12_model3_metrics.png)
*  Here is the sale price examples of model 3
<br>![model 3 sale price examples](Final_Project/images_ERD/13_model3_saleprice_examples.png)
*   As expected, model 3 is pretty good at predicting the Sale_Price as the two lines are overlapping
<br>![model 3 sale price prediction plot](Final_Project/images_ERD/15_model3_prediction_plot.png)
...
<br>![NN Model 4 summary](Final_Project/images_ERD/16_model4_summary.png)
*   One big difference is that it has no input of "List_Price"
*   Notice how the value of R2_squared is bad at 34.04%
<br>![model 3 metrics](Final_Project/images_ERD/16_model4_metrics.png)
*  Column "Prediction 4" lists the prediction of model 4.  Amazingly, it is far from the true Sale_Price.
<br>![model 4 sale price examples](Final_Project/images_ERD/17_model4_saleprice_examples.png)
*   As expected, model 4 is amazingly bad.
<br>![model 3 sale price prediction plot](Final_Project/images_ERD/18_model4_prediction_plot.png)
...
* <a href="https://docs.google.com/presentation/d/1SLSaP7A9qYda8DJs8cSLIt5KUAKRwIhh00xASNbRn84/edit?usp=sharing" target='_blank'>Presentation online</a><br>
...
*   <a href="https://docs.google.com/presentation/d/1SLSaP7A9qYda8DJs8cSLIt5KUAKRwIhh00xASNbRn84/" target="_blank">Google Slide</a> of our presentation.
*   This is an interactive <a href="Final_Project/Final_Project-CA%20Housing_Price_Analysis.twbx" target="_blank">Tableau Public</a>.
*   The final code is <a href="Final_Project/Final_Regression_NN_rfr.ipynb" target="_blank">Final_Regression_NN_rfr.ipynb</a>
    1. We expand our analysis to include the Random Forest Regressor
    <br>![Conclusion_r2_score_for_6_models](Final_Project/images_ERD/20_conclusion_r2_squared_6plot.png)
    2. Here is the result:
    <br>![Conclusion Prediction Value](Final_Project/images_ERD/20_conclusion_prediction_values.png)
    3. Right after the the shut down of the economy on March 2020, the California real estate market was pretty flat. After the election of 2020, the real estate market went up. However, it did not go in a straight line. It dipped in February 2021, and went up in April 2021.
    4. Regarding List_Price, Machine Learning would predicts more accurate if the data has a qualitative variable, like List_Price, or something similar like the quality of construction. <br> 
    <br> While "List_Price" is highly correlated with the "Sale_Price", in this analysis, List_Price serves as the **ONLY** quality parameter.  For example, sellers tend to ask for a higher price if the house has been remodeled recently.<br>
    5. For the near future, we need to build an interactive website whereas a user can input key information and can get out a predicted value.

*   Finally, we want to express our gratitude to all the instructional staff who make our 24 weeks duration assiduous and meaningful!
...
*   Machine Learning Model : Trong-Quyen Nguyen, Srividhya Thirumalairajan, Mikhail Zaatra & Dawit Alaro
